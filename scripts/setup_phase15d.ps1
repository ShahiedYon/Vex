...
Set-Content -Path (Join-Path $scriptsDir "phase15d_run.ps1") -Value $runner -Encoding UTF8

Write-Host ""
Write-Host "Phase 15d setup complete."
Write-Host "Run with:"
Write-Host "powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\phase15d_run.ps1"