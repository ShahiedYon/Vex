...
$pendingDir = Join-Path $VexTasks "queue\pending"
...
$taskLines = @()
$taskLines += "TASK_NAME: Vex Money Button"
$taskLines += "TASK_TYPE: vex.money_button"
$taskLines += "TARGET: run_daily_money_workflow"
$taskLines += "OUTPUT_TEXT: " + $outputText
$taskLines += "OUTPUT_LOG: " + $outputLog
$taskLines += "APPROVED: yes"
