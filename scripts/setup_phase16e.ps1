...
$null = New-Item -ItemType Directory -Force -Path $campaignsDir
...
Set-Content -Path (Join-Path $scriptsDir "phase16e_run.ps1") -Value $runner -Encoding UTF8

Write-Host ""
Write-Host "Phase 16e setup complete."
Write-Host "Run with:"
Write-Host "powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\phase16e_run.ps1"