...
Set-Content -Path (Join-Path $scriptsDir "partner_update.ps1") -Value $script -Encoding UTF8

Write-Host ""
Write-Host "Phase 16d setup complete."
Write-Host "Created:"
Write-Host "C:\Users\yonsh\Vex\scripts\partner_update.ps1"
Write-Host ""
Write-Host "Example:"
Write-Host 'powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\partner_update.ps1 -Id R-004 -ApprovalStatus applied -Notes "Application submitted" -NextAction "Wait for response and follow up in 3 days"'