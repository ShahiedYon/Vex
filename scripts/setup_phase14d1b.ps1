...
$null = New-Item -ItemType Directory -Force -Path $enhancedDir
...
Set-Content -Path (Join-Path $scriptsDir "phase14d1b_run.ps1") -Value $runner -Encoding UTF8

Write-Host ""
Write-Host "Phase 14d.1b setup complete."
Write-Host "Run with:"
Write-Host "powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\phase14d1b_run.ps1"