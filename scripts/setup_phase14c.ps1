...
$nodeScript = Join-Path $browser "phase14c_site_research.js"
$runnerScript = Join-Path $scripts "phase14c_run.ps1"
$logFile = Join-Path $logs "phase14c.log"
$checkFile = Join-Path $logs "phase14c-check.txt"
...
$checks = @'
[ ] phase14c_site_research.js created
[ ] phase14c_run.ps1 created
[ ] phase14c.log created
[ ] contact/about discovery enabled
[ ] social link extraction enabled
[ ] email/phone enrichment enabled
'@

Set-Content -Path $checkFile -Value $checks -Encoding UTF8

Write-Host ""
Write-Host "Phase 14c setup complete."
Write-Host "Run with:"
Write-Host "powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\phase14c_run.ps1 -url https://example.com"