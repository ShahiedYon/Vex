...
Set-Content -Path (Join-Path $scriptsDir "phase15b_run.ps1") -Value $runner -Encoding UTF8

Write-Host ""
Write-Host "Phase 15b setup complete."
Write-Host "Run with:"
Write-Host "powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\phase15b_run.ps1"