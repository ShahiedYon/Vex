...
Set-Content -Path (Join-Path $scriptsDir "phase16f_run.ps1") -Value $runner -Encoding UTF8

Write-Host ""
Write-Host "Phase 16f setup complete."
Write-Host "Run with:"
Write-Host "powershell -ExecutionPolicy Bypass -File C:\Users\yonsh\Vex\scripts\phase16f_run.ps1"